...
At the time this archive was written, a later implementation slice was expected to replace stubs with real authenticated venue wiring. That work has since moved into stable live-readiness docs.
...
This archived review is retained only for provenance. Current durable guidance lives in the stable docs under `docs/`.
